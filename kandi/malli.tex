...
Koska suoraan hyvää tai huonoa testattavuutta on vaikeaa määritellä, on erilaisia testattavuuteen vaikuttavia mittareita tutkittu paljon. Mittareiden käyttäminen tuo myös konkretiaa analysoimiseen ja niiden pohjalta on mahdollista tehdä esimerkiksi staattista analyysia suorittavia erillisiä ohjelmia. 
