...
Kaikista tutkielman aikana löytyneistä testattavuuteen vaikuttavista tekijöistä, jotka tulevat myös arkkitehtuurisella tasolla ilmi, voidaan nyt muodostaa seuraavanlainen taulukko
	...
	\centering
		\resizebox{\linewidth}{!}{
		\begin{tabular}{| m{3cm} | m{4cm} | m{4cm} | m{3.5cm} |}
		\hline
	\textbf{Tekijä} & \textbf{Tarkennus} & \textbf{Menetelmä} & \textbf{Lähde}\\ \hline
	
		Järjestelmän ominaisuudet & Komponenttien testattavuus, vastuut, vaatimukset, havaittavuus, hallittavuus ja jäljitettävyys  & Analysointi, pentagrammimalli & sourcet tulee tähän\\ \hline	
	
		Kompleksisuus & Kompleksinen toteutus, kompleksiset perintäsuhteet & Metriikat, UML, Graafimalli & d\\ \hline	
		
		Perintä & Ongelmalliset ja liialliset perintäsuhteet & Metriikat, UML, Graafimalli & d\\ \hline	
		
		Kytkentä & Itsekäyttö, suuret kytkentätasot & Metriikat, UML, Graafimalli, hajut & d\\ \hline		
		
		Riippuvuudet & Syklimäisyys, määrä, antimalli & UML, graafimalli, hajut & d\\ \hline
		
		Koheesio & Toiminta huonosti keskitettyä & Metriikat, hajut, analysointi & d\\ \hline
		
		Vastuut & Vastuut jakautuneet huonosti & Hajut, UML & d\\ \hline
