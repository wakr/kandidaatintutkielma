...
\noindent
Taulukon \ref{tab:coupAndCohes} tekijöistä nähdään, että ongelmat syntyvät, jos jollakin luokalla on ominaisuutena: liian suuri koko; riippuvuuksia paljon muihin luokkiin; toiminnallisuus hajautunut niin laajalle, että sen muuttaminen vaatii usean muutoksen eri kohteisiin. Nämä samat ominaisuudet saadaan arkkitehtuuriselle tasolle niin, että luokkien sijaan tarkastelu kohdistuu komponentteihin. Tätä väitettä tukee edellämainittujen arkkitehtuuristen hajujen ominaisuudet ja syyt.

On edellisten tarkasteluiden nojalla siis selvää, että hyvä kytkennän ja koheesion taso ovat tavoteltavia ominaisuuksia sekä kooditasolla että arkkitehtuuritasolla. Testattavuuden kannalta voidaan arvioida, että mitkä tekijät aiheuttavat esiteltyjä arkkitehtuurisia hajuja, josta tuloksena saatiin, että merkkittäviä tekijöitä olivat vastuut, riippuvuudet, koheesio ja kytkentä. Tekijöiden mittaamisen apuna arkkitehtuuriselta tasolta voidaan muun muassa käyttää luvussa \ref{arch_testability_measurement} esiteltyjä mittareita. Hybridihajujen tunnistaminen on taas yleisesti tärkeää, koska ne toimivat kriittisinä linkkeinä arkkitehtuurin ja koodipohjaisten ongelmien välillä. 
