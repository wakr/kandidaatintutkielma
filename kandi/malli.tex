...
UML eli \textit{Unified Modeling Language} on kokoelma erilaisia työkaluja näkymien luomiseen. Se määrittelee x määrän eri tarkoituksiin. \citep{UML}.
...
Vaikka arkkitehtuurisia hajuja on löydetty testattavuuden kannalta muutamia, niin niiden tunnistamiselle ei ole annettu yhtä oikeaa ratkaisua. Eräs näistä keinosta on esimerkiksi 
