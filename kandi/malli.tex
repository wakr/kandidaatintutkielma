...
Tutkimuksessa on käytetty pääosin kahdensuuntaistaista lumipallomenetelmää. Kirjallisuuskatsauksen avulla on ensin etsitty aiheesta merkittäviä tutkimuksia, joiden lähdeluettelon tarkastelun kautta on edetty paljon viitattuihin tutkimuksiin. Tämän jälkeen lähteitä on etsitty käänteisesti eli tutkimalla niitä tutkimuksia jotka ovat viitanneet löydettyihin tutkimuksiin.

Tutkielman tuloksena on saatu muodostettua seitsemän päätekijää, jotka löytyvät sekä ohjelmistojärjestelmän abstraktimmalta tasolta että konkreettisemmalta luokkatasolta. Osa näistä muodostetuista ominaisuuksista on metrillisiä ominaisuuksia, kun taas osa laadullisia ja kaikkia ominaisuuksia on mahdollista tarkastella visuaalisesta kuvauksesta riippuen kuvauksen abstraktiotasosta. Ominaisuudet on kerätty taulukkoon tämän tutkielman loppuun.
